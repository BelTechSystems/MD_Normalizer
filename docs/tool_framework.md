...
See `docs/decisions/DECISIONS.md` for the authoritative decision log.
...
Additional release and implementation decisions are recorded in `docs/decisions/DECISIONS.md`, including standalone CLI scope, code block preservation, overwrite policy, module invocation, and the v0.1.0 open-source release under BelTech Systems LLC.
